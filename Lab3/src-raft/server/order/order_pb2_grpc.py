...
class OrderStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AppendEntries = channel.unary_unary(
                '/order.Order/AppendEntries',
                request_serializer=order__pb2.AppendEntriesRequest.SerializeToString,
                response_deserializer=order__pb2.AppendEntriesResponse.FromString,
                )
        self.RequestLogs = channel.unary_unary(
                '/order.Order/RequestLogs',
                request_serializer=order__pb2.RequestLogsRequest.SerializeToString,
                response_deserializer=order__pb2.BoolResponse.FromString,
                )
        self.CommitIndex = channel.unary_unary(
                '/order.Order/CommitIndex',
                request_serializer=order__pb2.CommitIndexRequest.SerializeToString,
                response_deserializer=order__pb2.BoolResponse.FromString,
                )
...
def add_OrderServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AppendEntries': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.AppendEntriesRequest.FromString,
                    response_serializer=order__pb2.AppendEntriesResponse.SerializeToString,
            ),
            'RequestLogs': grpc.unary_unary_rpc_method_handler(
                    servicer.RequestLogs,
                    request_deserializer=order__pb2.RequestLogsRequest.FromString,
                    response_serializer=order__pb2.BoolResponse.SerializeToString,
            ),
            'CommitIndex': grpc.unary_unary_rpc_method_handler(
                    servicer.CommitIndex,
                    request_deserializer=order__pb2.CommitIndexRequest.FromString,
                    response_serializer=order__pb2.BoolResponse.SerializeToString,
            ),
    }
...
class Order(object):
    ...
    def AppendEntries(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/order.Order/AppendEntries',
            order__pb2.AppendEntriesRequest.SerializeToString,
            order__pb2.AppendEntriesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RequestLogs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/order.Order/RequestLogs',
            order__pb2.RequestLogsRequest.SerializeToString,
            order__pb2.BoolResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def CommitIndex(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/order.Order/CommitIndex',
            order__pb2.CommitIndexRequest.SerializeToString,
            order__pb2.BoolResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
